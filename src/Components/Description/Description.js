...
const Description = ({ project, contract, currentAccount, web3Provider }) => {
    ...
    if (fund) {
      ...
      await contract.methods
        ...
        .send({
          from: currentAccount,
          to: project[1],
          value: web3.utils.toWei(val !== null ? val : "0", "ether"),
          gas: 6721950,
        });
      window.location.replace(
        window.location.href.slice(0, window.location.href.length - 5)
      );
    } else {
  ...
  var images = [];
  images[0] =
    "https://pbs.twimg.com/card_img/1492856766534537217/Rz9RJade?format=png&name=small";
  images[1] =
    "https://ethereum.org/static/810eb64d89629231aa4d8c7fe5f20ee5/7c061/developers-eth-blocks.png";
  images[2] =
          ...
          <div className="cardDesc">
            ...
            <div className="cardDesc__body">
              ...
              <div className="halfDesc">
                <div className="descriptionDesc">
                  ...
                  <p>
                    <a
                      href={`https://github.com/${project.githubLink}/${project.title}`}
                      className="repolinkDesc"
                      target="_blank"
            ...
            <div className="cardDesc__footer">
              ...
              <div className="actionDesc">
                ...
                {currentAccount === project[1].toLowerCase() ? (
                  <React.Fragment>
                    <div>
                      Matching Share this round : {`${matchingAmount} ETH`}{" "}
                    </div>{" "}
                    <br></br>
