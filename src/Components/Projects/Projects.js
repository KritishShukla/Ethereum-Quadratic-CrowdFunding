          ...
          <div className="portfolio__wrapper">
            {
               arr.slice(0,3).map(i=>{
                 return (
                  ...
                  <img src="https://media.sproutsocial.com/uploads/2017/02/10x-featured-social-media-image-size.png" alt="Valorant Jett character" className="card__image" loading="lazy" />
